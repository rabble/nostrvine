...
_$SocialStateImpl _$$SocialStateImplFromJson(Map<String, dynamic> json) =>
    _$SocialStateImpl(
      likedEventIds: (json['likedEventIds'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toSet() ??
          const {},
      likeCounts: (json['likeCounts'] as Map<String, dynamic>?)?.map(
      ...
      likeEventIdToReactionId:
          (json['likeEventIdToReactionId'] as Map<String, dynamic>?)?.map(
              ...
              const {},
      repostedEventIds: (json['repostedEventIds'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toSet() ??
          const {},
      repostEventIdToRepostId:
          (json['repostEventIdToRepostId'] as Map<String, dynamic>?)?.map(
              ...
              const {},
      followingPubkeys: (json['followingPubkeys'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
      followerStats: (json['followerStats'] as Map<String, dynamic>?)?.map(
      ...
      likesInProgress: (json['likesInProgress'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toSet() ??
          const {},
      repostsInProgress: (json['repostsInProgress'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toSet() ??
          const {},
      followsInProgress: (json['followsInProgress'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toSet() ??
          const {},
    );

Map<String, dynamic> _$$SocialStateImplToJson(_$SocialStateImpl instance) =>
    <String, dynamic>{
