...
class VideoState {
  ...
  factory VideoState({
    ...
    assert(event != null, 'VideoEvent cannot be null');
  ...
  VideoState toFailed(String errorMessage) {
    ...
    if (loadingState == VideoLoadingState.permanentlyFailed) {
      throw StateError('Cannot transition to failed from permanently failed state');
    }
  ...
  VideoState toPermanentlyFailed(String errorMessage) {
    if (loadingState == VideoLoadingState.disposed) {
      throw StateError('Cannot transition to permanently failed from disposed state');
    }
  ...
  bool get canRetry => loadingState == VideoLoadingState.failed && 
