...
class AppLocalizationsIt extends AppLocalizations {
  ...
  @override
  String get commentsErrorReactionFailed => 'Impossibile reagire al commento';
  ...
  String commentReactionChipSemanticLabel(int count, String emoji) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count persone hanno reagito con $emoji',
      one: '1 persona ha reagito con $emoji',
    );
    return '$_temp0. Reagisci con $emoji';
  }
  ...
  String commentReactionChipOwnSemanticLabel(int count, String emoji) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count persone hanno reagito con $emoji, incluso tu',
      one: 'Hai reagito con $emoji',
    );
    return '$_temp0. Rimuovi la tua reazione';
  }
  ...
  String get minorAccountReviewMoveAccountTitle =>
      'Puoi portare il tuo account con te';

  @override
  String get minorAccountReviewMoveAccountBody =>
      'Puoi continuare a usare la tua identità Divine su un\'altra infrastruttura. Sposta il tuo account o scarica il tuo archivio.';

  @override
  String get minorAccountReviewMoveAccountCta => 'Sposta il tuo account';
