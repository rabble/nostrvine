...
class AppLocalizationsBg extends AppLocalizations {
  ...
  String get videoMetadataC2paMissingBody =>
      'Удостоверенията за съдържание изискват интернет връзка; без нея това видео няма да бъде потвърдено като създадено от човек. Свържете се отново и генерирайте пак или го публикувайте както е.';
