...
class AppLocalizationsPl extends AppLocalizations {
  ...
  String get dmDeleteFailedMessage =>
      'Nie udało się usunąć dla wszystkich. Twoja wiadomość nadal tu jest — spróbuj ponownie.';

  @override
  String get dmDeleteBlockedMessage =>
      'Twoje konto jest ograniczone, więc nie udało się usunąć tej wiadomości. Skontaktuj się z pomocą techniczną.';
