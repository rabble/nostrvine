...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get deleteAccountAccountChangedAfterDeletion =>
      'Se aceptaron algunas solicitudes de borrado, pero la limpieza se detuvo porque cambiaste de cuenta. Vuelve a entrar en la cuenta original para terminar.';
  ...
  String get deleteAccountRelayConfirmationFailed =>
      'No pudimos confirmar el borrado de la cuenta con ningún relay. Revisa tu conexión e inténtalo de nuevo.';
  ...
  String get commentsErrorReactionFailed =>
      'No se pudo reaccionar al comentario';
  ...
  String commentReactionChipSemanticLabel(int count, String emoji) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count personas reaccionaron con $emoji',
      one: '1 persona reaccionó con $emoji',
    );
    return '$_temp0. Reacciona con $emoji';
  }
  ...
  String commentReactionChipOwnSemanticLabel(int count, String emoji) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count personas reaccionaron con $emoji, incluyéndote',
      one: 'Reaccionaste con $emoji',
    );
    return '$_temp0. Quita tu reacción';
  }
  ...
  String get minorAccountReviewMoveAccountTitle =>
      'Puedes llevarte tu cuenta contigo';

  @override
  String get minorAccountReviewMoveAccountBody =>
      'Puedes seguir usando tu identidad de Divine en otra infraestructura. Mueve tu cuenta o descarga tu archivo.';

  @override
  String get minorAccountReviewMoveAccountCta => 'Mover tu cuenta';
