...
class AsyncUtils {
  ...
  /// ```
  static Completer<T> createCompletionHandler<T>() {
    return Completer<T>();
  }
...
class AsyncTimeoutException extends TimeoutException {
  AsyncTimeoutException(String message, Duration timeout) 
...
mixin AsyncInitialization {
  ...
  Future<void> get initialized => _initializationCompleter?.future ?? Future.value();
