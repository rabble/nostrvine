// ABOUTME: Widget that renders text with clickable hashtags and nostr: mentions
// ABOUTME: Parses hashtags and nostr: URIs in text and makes them tappable for navigation
...
class ClickableHashtagText extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Check if text contains any clickable elements
  ...
  List<TextSpan> _buildTextSpans(BuildContext context, WidgetRef ref) {
    ...
    // Combined regex to find both hashtags and nostr: URIs
