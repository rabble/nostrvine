...
bool shouldSkipRouteNormalization(String loc) {
  ...
  if (loc.startsWith(WelcomeScreen.path) ||
      ...
      loc.startsWith(MinorAccountReviewScreen.welcomePath) ||
      loc.startsWith(MinorAccountReviewParentConsentScreen.path) ||
      loc.startsWith(MinorAccountReviewUnder13Screen.path) ||
