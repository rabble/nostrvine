...
const followingCountProvider = FollowingCountProvider._();

/// Provider for following count (convenience wrapper)

final class FollowingCountProvider extends $FunctionalProvider<int, int, int>
    with $Provider<int> {
  /// Provider for following count (convenience wrapper)
...
String _$followingCountHash() => r'5bc7bfb3d59c8ba60c3d4952b7e39f32c9bfdc4f';
