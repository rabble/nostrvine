...
// ABOUTME: Drives the mandatory @divine.video name release on account deletion.
...
/// `(name, canonical)` record — `name` is the display form, `canonical` is
/// the round-trip-safe key sent to `/release` — or `null` if they own none
/// or it cannot be resolved.
///
/// Consumed by the delete-account flow: when this resolves to a non-null
/// value, deleting the account releases that name.
