...
class BookmarkResult {
  ...
  }) => BookmarkResult(success: false, outcome: outcome, feedback: feedback);
...
class BookmarkService with NostrListServiceMixin {
  ...
  Future<BookmarkResult> removeVideoFromGlobalBookmarks(
    String videoEventId,
  ) async {
  ...
  Future<BookmarkResult> toggleVideoInGlobalBookmarks(
    String videoEventId, {
    String? relay,
    String? petname,
  }) async {
