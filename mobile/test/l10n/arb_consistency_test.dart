...
const _knownUntranslatedDebt = <String>{
  ...
  'supporterDisclaimer',
  // #6495 added the ms/ur/vi/zh locales; these keys landed on main after
  // that pass and still need translations for those four locales.
  'publishErrorAccountChanged',
  'publishErrorOverlaysUnavailable',
  'settingsUploadInProgressMessage',
  'settingsUploadInProgressTitle',
  'videoEditorChromaKeyAmountHint',
  'videoEditorChromaKeyAmountLabel',
  'videoEditorChromaKeyApplying',
  'videoEditorChromaKeyAutoDetect',
  'videoEditorChromaKeyBackgroundColor',
  'videoEditorChromaKeyBackgroundImage',
  'videoEditorChromaKeyBackgroundLabel',
  'videoEditorChromaKeyBackgroundNone',
  'videoEditorChromaKeyBackgroundVideo',
  'videoEditorChromaKeyCloseSemanticLabel',
  'videoEditorChromaKeyDetectFailed',
  'videoEditorChromaKeyDoneSemanticLabel',
  'videoEditorChromaKeyEdgeHint',
  'videoEditorChromaKeyEdgeLabel',
  'videoEditorChromaKeyFailed',
  'videoEditorChromaKeyImagePickFailed',
  'videoEditorChromaKeyLabel',
  'videoEditorChromaKeyNoLibraryClips',
  'videoEditorChromaKeyPickClipTitle',
  'videoEditorChromaKeyPresetBlue',
  'videoEditorChromaKeyPresetGreen',
  'videoEditorChromaKeyPreviewUnavailable',
  'videoEditorChromaKeyRemove',
  'videoEditorChromaKeyRemoveFailed',
  'videoEditorChromaKeyScreenColorLabel',
  'videoEditorChromaKeySemanticLabel',
  'videoEditorChromaKeySpillHint',
  'videoEditorChromaKeySpillLabel',
  'videoEditorChromaKeyTitle',
