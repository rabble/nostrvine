...
void main() {
  group('ProfileScreen refresh tests', () {
    testWidgets('profile screen refreshes data when returning from setup', (WidgetTester tester) async {
    ...
    testWidgets('refresh button is positioned to avoid FAB overlap', (WidgetTester tester) async {
