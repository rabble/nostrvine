...
void main() {
  ...
  group(MyFollowersScreen, () {
    ...
    testWidgets('opens the sort sheet from the app bar', (tester) async {
      ...
      expect(find.text(l10n.followersSortTitle), findsOneWidget);
      expect(find.text(l10n.followersSortNewest), findsOneWidget);
      expect(find.text(l10n.followersSortOldest), findsOneWidget);
    });
    ...
    testWidgets('picking oldest first flips the dated followers', (
      ...
      await tester.tap(find.bySemanticsLabel(l10n.followersSortSemanticLabel));
      await tester.pumpAndSettle();
      await tester.tap(find.text(l10n.followersSortOldest));
      await tester.pumpAndSettle();
