...
void main() {
  group('Revine Fix Tests', () {
    ...
    test('VideoEvent.createRepostEvent should create proper repost structure', () {
      ...
      expect(repostVideoEvent.id, equals(originalVideoEvent.id)); // Original video ID
      ...
      print('✅ Repost VideoEvent structure is correct');
      print('  - Original author: ${repostVideoEvent.pubkey}');
      print('  - Reposter: ${repostVideoEvent.reposterPubkey}');
      print('  - isRepost: ${repostVideoEvent.isRepost}');
      print('  - Video URL preserved: ${repostVideoEvent.videoUrl}');
    });
    ...
    test('Profile repost filtering logic should work correctly', () {
      ...
      // Verify results
      expect(userReposts.length, equals(2), reason: 'User should have 2 reposts');
      expect(userReposts.every((v) => v.reposterPubkey == testUserPubkey), isTrue);
      ...
      expect(repostIds.contains('repost3'), isFalse, reason: 'Other user repost should not appear');
      
      print('✅ Profile repost filtering works correctly');
      print('  - Total videos in feed: ${allVideos.length}');
      print('  - User reposts found: ${userReposts.length}');
      print('  - Repost IDs: ${repostIds.toList()}');
    });
    ...
    test('includeReposts flag should be tracked correctly', () async {
      ...
      print('✅ VideoEventService initialized correctly');
      print('  - Classic vines pubkey available: ${videoEventService.classicVinesPubkey}');
    });
  });
}