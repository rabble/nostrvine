...
class TestVideoFiles {
  ...
  static TestColor _generateAnimatedColor(int x, int y, int width, int height, int frameIndex) {
...
class TestVideoScenario {
  ...
  @override
  String toString() {
    return 'TestVideoScenario(name: $name, frames: ${frames.length}, '
