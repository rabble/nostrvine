// ABOUTME: Comprehensive widget test for ClickableText covering core functionality
...
void main() {
  ...
  group('ClickableText - Comprehensive Tests', () {
      ...
      testWidgets('applies custom text style', (tester) async {
        ...
        await tester.pumpWidget(
          const MaterialApp(
            ...
            supportedLocales: AppLocalizations.supportedLocales,
            home: Scaffold(
              body: ClickableText(text: 'Plain text', style: testStyle),
            ),
          ),
        );
      ...
      testWidgets('uses default hashtag style when none provided', (
        ...
        await tester.pumpWidget(
          const MaterialApp(
            ...
            supportedLocales: AppLocalizations.supportedLocales,
            home: Scaffold(
              body: ClickableText(text: 'Text with #hashtag'),
            ),
          ),
        );
          ...
          const MaterialApp(
            ...
            home: Scaffold(
              body: SizedBox(
                ...
                child: ClickableText(text: longText, maxLines: 2),
              ),
            ),
          ),
        );
      ...
      testWidgets('navigates to hashtag feed when hashtag is tapped', (
        ...
        await tester.pumpWidget(
          MaterialApp(
            ...
            navigatorObservers: [mockObserver],
            home: const Scaffold(
              body: ClickableText(text: 'Check out #test'),
            ),
          ),
        );
      ...
      testWidgets('handles hashtags with numbers and underscores', (
        ...
        await tester.pumpWidget(
          const MaterialApp(
            ...
            supportedLocales: AppLocalizations.supportedLocales,
            home: Scaffold(
              body: ClickableText(text: 'Test #vine_2024 and #test_123'),
            ),
          ),
        );
      ...
      testWidgets('handles consecutive hashtags', (tester) async {
        await tester.pumpWidget(
          const MaterialApp(
            ...
            supportedLocales: AppLocalizations.supportedLocales,
            home: Scaffold(
              body: ClickableText(text: '#first#second hashtags'),
            ),
          ),
        );
      ...
      testWidgets('handles single hashtag character', (tester) async {
        await tester.pumpWidget(
          const MaterialApp(
            ...
            supportedLocales: AppLocalizations.supportedLocales,
            home: Scaffold(
              body: ClickableText(text: 'Just a # character'),
            ),
          ),
        );
