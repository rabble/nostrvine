...
class MockIVideoManager extends _i1.Mock implements _i7.IVideoManager {
  ...
  @override
  List<_i8.VideoEvent> get videos => (super.noSuchMethod(
        Invocation.getter(#videos),
        returnValue: <_i8.VideoEvent>[],
      ) as List<_i8.VideoEvent>);

  @override
  List<_i8.VideoEvent> get readyVideos => (super.noSuchMethod(
  ...
  @override
  _i4.Future<void> addVideoEvent(_i8.VideoEvent? event) => (super.noSuchMethod(
        Invocation.method(
          #addVideoEvent,
          [event],
        ),
