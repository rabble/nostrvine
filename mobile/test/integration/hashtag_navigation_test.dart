...
void main() {
  ...
  group('Hashtag Navigation Integration Tests', () {
    testWidgets('clicking hashtag navigates to explore screen with hashtag filter', (WidgetTester tester) async {
      // Start the app
      app.main();
    ...
    testWidgets('hashtag navigation maintains footer', (WidgetTester tester) async {
      // Start the app
      app.main();
      await tester.pumpAndSettle();
