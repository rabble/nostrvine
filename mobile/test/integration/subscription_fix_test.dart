...
void main() {
  ...
  test('Classic vines -> Open feed -> Editor picks sequence works correctly', () async {
    ...
    expect(subscriptionCalls[0]['authors']![0], 
      equals('25315276cbaeb8f2ed998ed55d15ef8c9cf2027baea191d1253d9a5c69a2b856'));
    expect(subscriptionCalls[0]['limit'], equals(100));
    
    // Verify subscription 2: Open feed (no author filter)
    expect(subscriptionCalls[1]['authors'], isNull,
    ...
    expect(subscriptionCalls[2]['authors']![0], 
