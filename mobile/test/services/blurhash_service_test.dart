...
import '../../lib/services/blurhash_service.dart';
...
void main() {
  group('BlurhashService', () {
    ...
    test('provides content-specific blurhashes', () {
      final comedyBlurhash = BlurhashService.getBlurhashForContentType(VineContentType.comedy);
      final natureBlurhash = BlurhashService.getBlurhashForContentType(VineContentType.nature);
    ...
    test('validates blurhash format', () {
      expect(BlurhashService.decodeBlurhash('L6Pj0^jE.AyE_3t7t7R**0o#DgR4'), isNotNull);
