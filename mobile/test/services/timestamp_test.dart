...
void main() {
  group('NostrTimestamp', () {
    ...
    test('should apply drift tolerance correctly', () {
      final driftTolerance = 300; // 5 minutes
    ...
    test('Kind 0 timestamp should be 5 minutes behind current time', () {
      ...
      print('Current time: $currentTime (${NostrTimestamp.format(currentTime)})');
      print('Kind 0 timestamp: $timestamp (${NostrTimestamp.format(timestamp)})');
      print('Difference: ${currentTime - timestamp} seconds');
