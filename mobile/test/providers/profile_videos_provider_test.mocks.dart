...
// in nostrvine_app/test/providers/profile_videos_provider_test.dart.
...
import 'package:nostr/nostr.dart' as _i5;
import 'package:nostrvine_app/models/nip94_metadata.dart' as _i6;
...
class MockINostrService extends _i1.Mock implements _i3.INostrService {
  ...
  _i4.Stream<_i5.Event> subscribeToEvents(
          {required List<_i5.Filter>? filters}) =>
      (super.noSuchMethod(
        Invocation.method(
          #subscribeToEvents,
          [],
  ...
  _i4.Future<_i3.NostrBroadcastResult> publishFileMetadata({
    required _i6.NIP94Metadata? metadata,
