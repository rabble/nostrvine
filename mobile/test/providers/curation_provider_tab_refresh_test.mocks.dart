...
class MockLikesRepository extends _i1.Mock implements _i3.LikesRepository {
  ...
  @override
  _i10.Future<({Map<String, int> downvotes, Map<String, int> upvotes})>
  ...
  @override
  _i10.Future<({Set<String> downvotedIds, Set<String> upvotedIds})>
  getUserVoteStatuses(List<String>? eventIds) =>
      (super.noSuchMethod(
          ...
          as _i10.Future<({Set<String> downvotedIds, Set<String> upvotedIds})>);

  @override
  _i10.Future<String> downvoteEvent({
    required String? eventId,
    required String? authorPubkey,
    int? targetKind,
  }) =>
  ...
  @override
  _i10.Future<void> deleteReaction(String? reactionEventId) =>
      (super.noSuchMethod(
