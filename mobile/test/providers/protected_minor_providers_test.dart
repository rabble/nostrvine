...
void main() {
  ...
  group('protectedMinorStatusProvider', () {
    test(
      'unauthenticated resolves to not-protected without any fetch',
      () async {
        ...
        final status = await container.read(
          protectedMinorStatusProvider.future,
        );
  ...
  group('isProtectedMinorProvider', () {
    test(
