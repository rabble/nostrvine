...
void main() {
  group('SubscriptionManager Filter Preservation', () {
    ...
    test('should preserve hashtag filters when optimizing', () async {
      ...
      final capturedCalls = verify(mockNostrService.subscribeToEvents(
      ...
      expect(optimizedFilter.limit, lessThanOrEqualTo(100)); // Should be optimized
    });
    ...
    test('should preserve both hashtag and group filters', () async {
      ...
      final originalFilter = Filter(
        ...
        t: ['funny', 'viral'],
        h: ['vine'],
        authors: ['npub1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq', 'npub2qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq'],
        limit: 250,
      );
      ...
      expect(optimizedFilter.h, equals(['vine']));
      expect(optimizedFilter.authors, equals(['npub1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq', 'npub2qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq']));
      expect(optimizedFilter.kinds, equals([22]));
    ...
    test('should handle null hashtag and group filters', () async {
      ...
      final originalFilter = Filter(
        kinds: [22],
        authors: ['npub1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq'],
        limit: 50,
      );
      ...
      expect(optimizedFilter.authors, equals(['npub1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq']));
      expect(optimizedFilter.kinds, equals([22]));
    });
