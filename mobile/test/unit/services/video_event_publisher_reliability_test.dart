...
void main() {
  ...
  group('VideoEventPublisher reliability', () {
    test('accepted-by-any → success result with outcome + feedback', () async {
    ...
    test('resumable signed-event cache is populated on signing '
        '(preserved across retry-logic migration)', () async {
      final signedEvent = createSignedEvent();
      stubSigning(signedEvent);
      stubPublishOutcome(
        PublishOutcome(
