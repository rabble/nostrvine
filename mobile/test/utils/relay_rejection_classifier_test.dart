...
void main() {
  group('isAccountRestrictedReason', () {
    test('recognizes only explicit account-level relay restrictions', () {
      ...
      expect(
        isAccountRestrictedReason('blocked: missing required tag'),
        isFalse,
      );
      ...
      // loosening.
      expect(
        isAccountRestrictedReason('blocked: pubkey is suspended.'),
        isFalse,
      );
      expect(
  ...
  group('isAccountRestrictedOutcome', () {
    test('requires the trusted relay to report an account restriction', () {
      ...
      const untrustedRestriction = PublishOutcome(
        ...
        acceptedBy: [],
        rejectedBy: {
          'wss://third-party.example': 'blocked: pubkey is suspended',
        },
