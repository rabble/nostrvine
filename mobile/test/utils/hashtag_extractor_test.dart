...
import 'package:nostrvine_app/utils/hashtag_extractor.dart';
...
void main() {
  group('HashtagExtractor', () {
    ...
    test('normalizes hashtags', () {
      ...
      expect(normalized, equals(['funny', 'coding', 'bitcoin', 'mytag', 'valid_tag']));
    });
    ...
    test('combines caption and additional hashtags', () {
      final combined = HashtagExtractor.combineHashtags(
        ...
        additionalHashtags: ['nostrvine', 'comedy', 'funny'], // 'funny' should be deduplicated
      );
