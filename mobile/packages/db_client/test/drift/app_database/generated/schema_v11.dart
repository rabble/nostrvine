...
class DirectMessages extends Table
  ...
  late final GeneratedColumn<int> twinCollapsed = GeneratedColumn<int>(
    'twin_collapsed',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (twin_collapsed IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  late final GeneratedColumn<String> ownerPubkey = GeneratedColumn<String>(
    'owner_pubkey',
...
class DirectMessagesData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['twin_collapsed'] = Variable<int>(twinCollapsed);
    if (!nullToAbsent || ownerPubkey != null) {
      map['owner_pubkey'] = Variable<String>(ownerPubkey);
    }
  ...
  factory DirectMessagesData.fromJson(
    ...
    return DirectMessagesData(
      ...
      twinCollapsed: serializer.fromJson<int>(json['twinCollapsed']),
      ownerPubkey: serializer.fromJson<String?>(json['ownerPubkey']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'twinCollapsed': serializer.toJson<int>(twinCollapsed),
      'ownerPubkey': serializer.toJson<String?>(ownerPubkey),
...
class DirectMessagesCompanion extends UpdateCompanion<DirectMessagesData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (twinCollapsed.present) {
      map['twin_collapsed'] = Variable<int>(twinCollapsed.value);
    }
    if (ownerPubkey.present) {
      map['owner_pubkey'] = Variable<String>(ownerPubkey.value);
    }
...
class RemovedConversations extends Table
    with TableInfo<RemovedConversations, RemovedConversationsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  RemovedConversations(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> conversationId = GeneratedColumn<String>(
    'conversation_id',
    aliasedName,
    false,
  ...
  @override
  RemovedConversationsData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return RemovedConversationsData(
      conversationId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}conversation_id'],
      )!,
  ...
  @override
  RemovedConversations createAlias(String alias) {
    return RemovedConversations(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const [
    'PRIMARY KEY(conversation_id, owner_pubkey)',
  ];
  @override
  bool get dontWriteConstraints => true;
}

class RemovedConversationsData extends DataClass
    implements Insertable<RemovedConversationsData> {
  final String conversationId;
  final String ownerPubkey;
  final int removedAt;
  const RemovedConversationsData({
    required this.conversationId,
    required this.ownerPubkey,
  ...
  factory RemovedConversationsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  RemovedConversationsData copyWith({
    String? conversationId,
    String? ownerPubkey,
    int? removedAt,
  }) => RemovedConversationsData(
    conversationId: conversationId ?? this.conversationId,
    ownerPubkey: ownerPubkey ?? this.ownerPubkey,
    removedAt: removedAt ?? this.removedAt,
  );
  RemovedConversationsData copyWithCompanion(
    RemovedConversationsCompanion data,
  ) {
    return RemovedConversationsData(
      conversationId: data.conversationId.present
          ? data.conversationId.value
  ...
  @override
  String toString() {
    return (StringBuffer('RemovedConversationsData(')
          ..write('conversationId: $conversationId, ')
          ..write('ownerPubkey: $ownerPubkey, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is RemovedConversationsData &&
          other.conversationId == this.conversationId &&
          other.ownerPubkey == this.ownerPubkey &&
...
class RemovedConversationsCompanion
    extends UpdateCompanion<RemovedConversationsData> {
  final Value<String> conversationId;
  final Value<String> ownerPubkey;
  ...
  RemovedConversationsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       ownerPubkey = Value(ownerPubkey),
       removedAt = Value(removedAt);
  static Insertable<RemovedConversationsData> custom({
    Expression<String>? conversationId,
    Expression<String>? ownerPubkey,
...
class DatabaseAtV11 extends GeneratedDatabase {
  ...
  late final RemovedConversations removedConversations = RemovedConversations(
    this,
  );
