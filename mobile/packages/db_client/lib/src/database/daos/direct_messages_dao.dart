...
class DirectMessagesDao extends DatabaseAccessor<AppDatabase>
  ...
  /// conversation. Used for cross-protocol dedup when both a NIP-17 and
  /// NIP-04 copy of the same message arrive.
  ///
  /// Intentionally omits `createdAt` from the match because the NIP-17 rumor
  /// and NIP-04 event may have slightly different timestamps (generated by
  /// separate `Event()` constructor calls).
