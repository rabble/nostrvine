// ABOUTME: Tests that CurationRepository uses publishEventWithRetry for kind
...
void main() {
  ...
  late CurationRepository service;
  ...
  group('CurationRepository reliability', () {
    test(
    ...
    test('duplicate concurrent publish returns duplicate failure', () async {
