...
void main() {
  ...
  group('CurationRepository edge cases', () {
    ...
    group('_updateVideoCache', () {
      test('populates cache with matching videos from '
          'discovery', () async {
        ...
        // videos
        final videos = curationRepository.getVideosForSet('test_set');
    ...
    group('refreshCurationSets stream error', () {
      test('handles stream error during refresh', () async {
        curationRepository = CurationRepository(
          nostrService: mockNostrService,
          videoEventCache: mockVideoEventCache,
          likesRepository: mockLikesRepository,
      ...
      test('handles parse error in refreshCurationSets '
        ...
        final set = curationRepository.getCurationSet('good_set');
        expect(set, isNotNull);
      });
    });

    group('createCurationSet exception', () {
      test('returns false when publishCuration throws '
          'exception', () async {
    ...
    // curation_repository_reliability_test.dart.
  });
}
