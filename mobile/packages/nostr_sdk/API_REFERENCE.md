...
Keyless signer used before sign-in resolves, or after sign-out. It reports an
empty public key so keyed operations stay gated, and throws from signing and
encryption entry points instead of returning `null`.
