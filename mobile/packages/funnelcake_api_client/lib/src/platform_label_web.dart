...
///
/// Web cannot send a platform signal on its own headers: `User-Agent` is a
/// forbidden header the browser drops, and a custom header like
...
/// User-Agent — non-iOS, default treatment.
