...
// .wrangler/tmp/bundle-4e34DV/strip-cf-connecting-ip-header.js
  ...
  try {
    ...
    for (const key of keys) {
      ...
      try {
        ...
        if (creatorData.totalViews < minViews)
          continue;
...
// .wrangler/tmp/bundle-4e34DV/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-4e34DV/middleware-loader.entry.ts
