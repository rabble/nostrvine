...
echo ""
echo "Point local_stack at them for this shell:"
echo ""
print_exports | sed 's/^/    /'
echo ""
echo "Then: mise run local_up"
echo ""
echo "The schema jumps from 70 to current, so reset the ClickHouse volume first"
echo "if the stack has been up on the pinned images:"
echo ""
