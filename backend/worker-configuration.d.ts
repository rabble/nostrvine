/* eslint-disable */
// Generated by Wrangler by running `wrangler types --cwd ../backend` (hash: 33ee71387d18b4fc200418f1a13a17e6)
// Runtime types generated with workerd@1.20250525.0 2025-06-14 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		CLOUDINARY_API_KEY: string; // Set as secret
		CLOUDINARY_API_SECRET: string; // Set as secret
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "BASE_URL" | "MAX_FILE_SIZE_FREE" | "MAX_FILE_SIZE_PRO" | "WEBHOOK_SECRET" | "CLOUDINARY_CLOUD_NAME">> {}
}
